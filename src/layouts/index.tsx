...
export default class Index extends React.Component<{ children: any }, { showNav: boolean }> {
                ...
                <div className='main__header'>
                    <div className='main__container'>
                        ...
                        <div className={classNames('main__header-nav', { show: this.state.showNav })}>
                            ...
                            <div className='main__header-subnav'>
                                <a href='get-started/overview'>Overview</a>
                                <a href='get-started/architecture'>Architecture</a>
                                <a href='get-started/features'>Features</a>
                                <a href='get-started/tutorials'>Tutorials</a>
                            </div>
                            <a href='docs'>Docs</a>
                            <a href='community'>Community</a>
                            <div className='main__header-subnav'>
                                <a href='community/overview'>Community</a>
                                <a href='community/releases'>Releases</a>
                            </div>
                            <a href='https://blog.argoproj.io/' target='_blank'>Blog</a>
                            <a href='get-started/installation'>Install</a>
                            <a href='https://github.com/argoproj/argo' target='_blank'>
                                <i className='fa fa-github' /> <span className='github-text'>GitHub Project</span>
                            </a>
                            <div className='main__header-nav-close' onClick={() => this.toggleNav()}>
                                <i className='fa fa-times' />
                            </div>
                        </div>
                        <div className='main__header-nav-toggle' onClick={() => this.toggleNav()}>
